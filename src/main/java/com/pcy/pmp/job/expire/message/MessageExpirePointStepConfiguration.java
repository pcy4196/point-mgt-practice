...
import com.pcy.pmp.job.listener.InputExpiredPointAlarmCriteriaDateStepListener;
...
@Configuration
@AllArgsConstructor
public class MessageExpirePointStepConfiguration {

    private final StepBuilderFactory stepBuilderFactory;
    private final InputExpiredPointAlarmCriteriaDateStepListener listener;
